...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag=$DOCKER_ACCOUNT/microservice-kubernetes-demo-catalog microservice-kubernetes-demo-catalog
...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag=$DOCKER_ACCOUNT/microservice-kubernetes-demo-customer microservice-kubernetes-demo-customer
...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag=$DOCKER_ACCOUNT/microservice-kubernetes-demo-order microservice-kubernetes-demo-order
